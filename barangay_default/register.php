...
<head>
    ...
    <style>
        ...
        .double {
            ...
            background-image: url('assets/logo/a.jpg');
    ...
    <nav class="main-header navbar navbar-expand-md" style="background-color: #0037af">
        <div class="container">
            <a href="" class="navbar-brand">
                ...
                <span class="brand-text text-white" style="font-weight: 700">INVENTORY SYSTEM</span>
            </a>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select name="add_department" id="add_department" class="form-control">
                                                    <option value=""></option>
                                                    <option value="Warehouse">Warehouse</option>
                                                    <option value="Accounting">Accounting</option>
                                                    <option value="HR">HR</option>
                                                    <option value="Finance">Hospitality Management</option>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select name="add_position" id="add_position" class="form-control">
                                                    <option value=""></option>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select name="add_access_level" id="add_access_level" class="form-control">
                                                    <option value=""></option>
...
$(document).ready(function(){
        ...
        if (this.files && this.files[0]) {
            ...
            if($.inArray(fileExtension, ['gif','png','jpg','jpeg']) == -1) {
                Swal.fire({
                    ...
                    icon: 'error',
                    html: '<b>Invalid Image File. Please upload only image files (gif, png, jpg, jpeg)</b>',
                    width: '400px',
            ...
            $.ajax({
                ...
                error: function(xhr, status, error) {
                    Swal.fire({
                        title: '<strong class="text-danger">ERROR</strong>',
                        icon: 'error',
                        html: '<b>Something went wrong with the registration!</b>',
                        width: '400px',
                        confirmButtonColor: '#6610f2',
                    });
                }
    ...
    $("#add_first_name, #add_middle_name, #add_last_name, #add_suffix").inputFilter(function(value) {
